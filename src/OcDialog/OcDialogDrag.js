...
var OcDialogDrag = {
    ...
    initialize(dialog) {
        ...
        dialog.addEventListener('mousedown', OcDialogDrag.handleMouseDown);
        dialog.addEventListener('touchstart', OcDialogDrag.handleTouchStart, { passive: false });
    },
    ...
    cleanup(dialog) {
        ...
        dialog.removeEventListener('mousedown', OcDialogDrag.handleMouseDown);
        dialog.removeEventListener('touchstart', OcDialogDrag.handleTouchStart);
    ...
    handleMouseDown(e) {
        OcDialogDrag.startDrag(e, e.clientX, e.clientY);
    },

    handleTouchStart(e) {
        if (e.touches.length === 1) {
            const touch = e.touches[0];
            OcDialogDrag.startDrag(e, touch.clientX, touch.clientY);
        }
    },
    ...
    startDrag(e, clientX, clientY) {
        ...
        document.addEventListener('mousemove', OcDialogDrag.createBoundHandler(dialog, 'handleMouseMove'));
        document.addEventListener('touchmove', OcDialogDrag.createBoundHandler(dialog, 'handleTouchMove'), { passive: false });
        document.addEventListener('mouseup', OcDialogDrag.createBoundHandler(dialog, 'handleMouseUp'));
        document.addEventListener('touchend', OcDialogDrag.createBoundHandler(dialog, 'handleTouchEnd'));
        document.addEventListener('mouseleave', OcDialogDrag.createBoundHandler(dialog, 'handleMouseUp'));
    },

    createBoundHandler(dialog, method) {
        return function(e) {
            OcDialogDrag[method](e, dialog);
        };
    },

    handleMouseMove(e, dialog) {
        OcDialogDrag.updateDrag(e.clientX, e.clientY, dialog);
    },
    ...
    handleTouchMove(e, dialog) {
        if (dialog._schDragState?.isDragging && e.touches.length === 1) {
            e.preventDefault();
            const touch = e.touches[0];
            OcDialogDrag.updateDrag(touch.clientX, touch.clientY, dialog);
        }
    },
    ...
    endDrag(dialog) {
        ...
        document.removeEventListener('mousemove', OcDialogDrag.createBoundHandler(dialog, 'handleMouseMove'));
        document.removeEventListener('touchmove', OcDialogDrag.createBoundHandler(dialog, 'handleTouchMove'));
        document.removeEventListener('mouseup', OcDialogDrag.createBoundHandler(dialog, 'handleMouseUp'));
        document.removeEventListener('touchend', OcDialogDrag.createBoundHandler(dialog, 'handleTouchEnd'));
        document.removeEventListener('mouseleave', OcDialogDrag.createBoundHandler(dialog, 'handleMouseUp'));
