...
class Session {
    ...
    protected function start(int $lifetimeSeconds): void {
        ...
        $_SESSION['_session_name'] = $this->sessionName;
    }
    ...
    public function isLoggedIn(): bool { return !empty( $_SESSION[$this->sessionName . "_" . 'loggedin']); }
    public function login(array $sessionVars = []): void {
        $_SESSION[$this->sessionName . "_" . 'loggedin'] = TRUE;
