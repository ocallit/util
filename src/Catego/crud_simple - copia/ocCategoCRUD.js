...
const ocCategoCRUD = {
    ...
    updateWidgetFromCRUD() {
        ...
        const currentSelected = OcCategoWidget.getValue(this.currentWidget);
        ...
        // Update the widget
        OcCategoWidget.updateWidgetCategories(this.currentWidget, widgetCategories);
        ...
        OcCategoWidget.setValue(this.currentWidget, validSelectedValues);
    ...
    init() {
        ...
        console.log('✅ ocCategCrud,init(): initialized', this.version);
    }
};
