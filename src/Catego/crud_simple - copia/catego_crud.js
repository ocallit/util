...
const ocCategoCRUD = {
            ...
            <div class="sch_form_group">
                ...
                <div class="oc_catego_crud_input_container">
                    <input type="text" 
                           ...
                           required>
                    <button type="button" class="oc_catego_crud_input_clear" onclick="this.previousElementSibling.value=''" aria-label="Limpiar búsqueda">&times;</button>
                </div>
            </div>
        `;
    ...
    // Initialize the component asdfasdfasdf
    init() {
        ...
        console.log('✅ ocCategoCRUD.init(): initialized', this.version);
    }
};
